...
def search_character(): #c+v on update_character dawgs
    if not view_characters():
        print("\nNo characters to search.")
        return
    
    print("\nSearching Character...")
    sooo_valid = ["1", "2", "3", "4", "5", "ID", "Name", "Arcane", "Nationality", "Exit"]
    BruhMoment = False
    ...
    terms = {
        ...
        "2": "name", "Name": "name",
        "3": "arcane", "Arcane": "arcane",
        "4": "nationality", "Nationality": "nationality",
    }
    ...
    query = f"SELECT * FROM characters WHERE {field} LIKE %s"
